 ...
 * @author Wine
 */
public class ProtGeraOrdemProducao extends javax.swing.JPanel {
     ...
     */
    public ProtGeraOrdemProducao(JFrame jfChamador) {
        initComponents();
        ...
        gridOrdemProducao.setAutoscrolls(false);
        gridOrdemProducao.setEditingRow(0);
        gridOrdemProducao.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        gridOrdemProducao.getTableHeader().setReorderingAllowed(false);
        jScrollPane1.setViewportView(gridOrdemProducao);
        gridOrdemProducao.getColumnModel().getColumn(0).setPreferredWidth(20);
        gridOrdemProducao.getColumnModel().getColumn(1).setPreferredWidth(100);
        gridOrdemProducao.getColumnModel().getColumn(2).setPreferredWidth(20);
        gridOrdemProducao.getColumnModel().getColumn(3).setPreferredWidth(20);
        gridOrdemProducao.getColumnModel().getColumn(4).setPreferredWidth(20);
        gridOrdemProducao.getColumnModel().getColumn(5).setPreferredWidth(20);
        gridOrdemProducao.getColumnModel().getColumn(6).setPreferredWidth(20);

        gridOrdemProducao.setModel(tmOrdemProducao);

        gridOrdemProducao.setCellSelectionEnabled(false);
        gridOrdemProducao.setRowSelectionAllowed(true);
    ...
    private void initComponents() {
        ...
        gridOrdemProducao = new javax.swing.JTable();
        ...
        btnIncluirProdPedido1 = new javax.swing.JButton();
        ...
        btnSalvar.setText("Gerar Ordem de Produção");
        ...
        gridOrdemProducao.setAutoCreateRowSorter(true);
        gridOrdemProducao.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        btnIncluirProdPedido.setText("Aplicar Filtro");
        ...
        cmbTamProdPedido.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione...", "P", "M", "G", "GG", "EG", "EGG", "1", "2", "4", "6", "8", "10", "12", "14", "16", "34", "36", "38", "40", "42", "44", "46", "48", "50", "52", "54", "56" }));

        jLabel7.setText("Cor:");

        cmbCorProdPedido.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Selecione...", "AZUL", "AMARELO", "VERDE", "VERMELHO", "PRETO", "BRANCO", "BRANCO/PRETO", "LISTRADO BRANCO/PRETO" }));

        btnIncluirProdPedido1.setText("RemoverFiltro");
        btnIncluirProdPedido1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnIncluirProdPedido1ActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                        .addGap(0, 0, Short.MAX_VALUE)
                        .addComponent(btnIncluirProdPedido1)
                        .addGap(18, 18, 18)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        JOptionPane.showMessageDialog(this, "Ordem gerada com sucesso!", "", JOptionPane.INFORMATION_MESSAGE);
        limparCampos();
    ...
    private void btnIncluirProdPedidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirProdPedidoActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Filtro aplicado com sucesso!", "", JOptionPane.INFORMATION_MESSAGE);

    }//GEN-LAST:event_btnIncluirProdPedidoActionPerformed

    private void btnIncluirProdPedido1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirProdPedido1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnIncluirProdPedido1ActionPerformed

    // Variables declaration - do not modify//GEN-BEGIN:variables
    javax.swing.JButton btnFechar;
    javax.swing.JButton btnIncluirProdPedido;
    javax.swing.JButton btnIncluirProdPedido1;
    ...
    javax.swing.JTable gridOrdemProducao;
