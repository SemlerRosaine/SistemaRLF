 ...
 * @author Wine
 */
public class ProtCadastraProduto extends javax.swing.JPanel {
    JFrame telaChamadora;
    /**
     * Creates new form ProtCadastraCliente
     */
    public ProtCadastraProduto(JFrame jfChamador) {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtVlrCustoProduto = new javax.swing.JTextField();
        ...
        lstTamSelecProduto = new javax.swing.JList();
        ...
        lstCoresSelecProduto = new javax.swing.JList();
        jPanel3 = new javax.swing.JPanel();
        jSeparator1 = new javax.swing.JSeparator();
        btnFechar = new javax.swing.JButton();
        btnSalvar = new javax.swing.JButton();

        setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastro de Produtos"));
        setAutoscrolls(true);
        ...
        txtCodProduto.setFocusable(false);
        ...
        lstTamDispProduto.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "P", "M", "G", "GG", "EG", "EGG", "1", "2", "4", "6", "8", "10", "12", "14", "16", "34", "36", "38", "40", "42", "44", "46", "48", "50", "52", "54", "56" };
        ...
        lstCoresDispProduto.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "AZUL", "AMARELO", "VERDE", "VERMELHO", "PRETO", "BRANCO", "BRANCO/PRETO", "LISTRADO BRANCO/PRETO" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtVlrCustoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 94, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(txtDescProduto, javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btnExcluirTamProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirTamProdutoActionPerformed
        ...
        for (int i = 0; i < lstTamDispProduto.getModel().getSize(); i++)
            lmTamDispProdt.addElement(lstTamDispProduto.getModel().getElementAt(i));
        DefaultListModel lmTamSelecProdt = new DefaultListModel();
        for (int i = 0; i < lstTamSelecProduto.getModel().getSize(); i++)
            lmTamSelecProdt.addElement(lstTamSelecProduto.getModel().getElementAt(i));
    ...
    private void btnExcluirCorProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirCorProdutoActionPerformed
        ...
        for (int i = 0; i < lstCoresDispProduto.getModel().getSize(); i++)
            lmCoresDispProdt.addElement(lstCoresDispProduto.getModel().getElementAt(i));
        DefaultListModel lmCoresSelecProdt = new DefaultListModel();
        for (int i = 0; i < lstCoresSelecProduto.getModel().getSize(); i++)
            lmCoresSelecProdt.addElement(lstCoresSelecProduto.getModel().getElementAt(i));
    ...
    javax.swing.JTextField txtDescProduto;
    javax.swing.JTextField txtVlrCustoProduto;
